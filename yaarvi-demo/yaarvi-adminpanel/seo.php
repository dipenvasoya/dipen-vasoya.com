...
<head>
        ...
        ?>
        <title>SEO | <?php echo $row['company_name'];?></title>
        <?php }?>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">SEO</h4>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Update SEO</h4><br/>
                                        <form action="" method="POST">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <?php if(isset($row["seo_id"])){?>
								                            <input type="hidden" name="seo_id" value="<?php echo $row['seo_id'];?>" />
									                    <?php }?>
                                                        <script src="ckeditor/ckeditor.js"></script>
                                                        <textarea id="editor1" name="page_title" class="form-control" rows="3" required><?php echo $row['seo_title'];?></textarea>
                                                        <script>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <script src="ckeditor/ckeditor.js"></script>
                                                        <textarea id="editor2" name="page_keyword" class="form-control" rows="3" required><?php echo $row['seo_keyword'];?></textarea>
                                                        <script>
                                            ...
                                            <div class="d-flex flex-wrap gap-2">
                                                <button type="submit" name="update_seo" class="btn btn-primary waves-effect waves-light">Update <i class="fas fa-paper-plane bx-spin"></i></button>
                        ...
                        <?php
                            ...
                            if (isset($_POST["update_seo"])) {
                                ...
                                $query="UPDATE seo set seo_title='".$page_title."',
                                seo_keyword='".$page_keyword."' WHERE seo_id ='".$_POST['seo_id']."'";
